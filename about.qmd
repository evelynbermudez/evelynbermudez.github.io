...
::: {layout-nrow=3 layout-valign="bottom"}
![Sunset Run at Coal Oil Point](media/sunsets.jpeg){group="gallery"} 
!["Ran" into a little friend on DP at sunset](media/sunset1.jpeg){group="gallery"} 
![Sunset after a rainy week](media/sunset2.jpeg){group="gallery"} 
![Sunset Run at Devs](media/sunset3.jpeg){group="gallery"} 
![Sunset Run on DP](media/sunset4.jpeg){group="gallery"} 
![Morning run at Campus Point](media/morning.jpeg){group="gallery"}
![Morning Run at the end of DP](media/morning2.jpeg){group="gallery"}
![Morning Run at Coal Oil Point](media/morning3.jpeg){group="gallery"}
![5K Turkey Trot at the UCSB Lagoon in Fall 2023](media/turkey_trot.jpeg){group="gallery"}
:::
